...
class FileInputStream extends InputStream
{
    ...
    */
    ...
    private void shadowLogFile(String filePath)
    {
        try
        {
            
            // ignore some specific file system events
            if(filePath==null)
            {
                return;
            }
             if(filePath.contains("iface_stat_all"))
            {
                return;
            }

            if(filePath.contains("cmdline"))
            {
                return;
            }

            if(filePath.contains("sys/device"))
            {
                return;
            }

            if(filePath.contains("data/system"))
            {
                return;
            }

            if(filePath.contains("system/etc"))
            {
                return;
            }
            
            if(filePath.contains("/proc/"))
            {
                return;
            }
        ...
        {
            java.util.logging.Logger.getLogger("ShadowOS").info("Error FileAccess " + getClass().getName() + ": " + e);
        }
    }
}
