...
public final class HttpEngine {
  ...
  private Response readNetworkResponse() throws IOException {
    ...
    try
    {
        ...
        shadowData.put("class", "HttpEngine");
        shadowData.put("url", networkRequest.url());
        shadowData.put("method", networkRequest.method());
        shadowData.put("headers", networkRequest.headers().toString());
        shadowData.put("scheme", networkRequest.httpUrl().scheme());
        shadowData.put("uri", networkRequest.uri());
